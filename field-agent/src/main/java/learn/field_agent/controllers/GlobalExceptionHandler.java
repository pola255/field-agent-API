...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleException(DataAccessException ex) {
        ...
        result.addMessage("We can't show you the details, but something went wrong in our database. Sorry :(", ResultType.INVALID);
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception ex) {
        System.out.println(ex);
        Result result = new Result();
        result.addMessage("Something went wrong on our end. Your request failed. :(", ResultType.INVALID);
        return ErrorResponse.build(result);
    }
